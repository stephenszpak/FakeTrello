...
namespace FakeTrello.Tests.DAL
{
    ...
    public class FakeTrelloRepoTests
    {
        ...
        public void Setup()
        {
            ...
            sally = new ApplicationUser { Id = "sally_id_1" };
            sammy = new ApplicationUser { Id = "sammy_id_1" };
        }
        ...
        public void EnsureICanGetUserBoards()
        {
            ...
            fake_board_table.Add(new Board { BoardId = 2, Name = "My Board 2", Owner = sally });
            fake_board_table.Add(new Board { BoardId = 3, Name = "My Board 3", Owner = sammy });

            CreateFakeDatabase();

            //Act
            int expect_board_count = 2;
        ...
        [TestMethod]
        public void EnsureICanDeleteBoards()
        {
            //Arrange
            fake_board_table.Add(new Board { BoardId = 1, Name = "My Board", Owner = sally });
            fake_board_table.Add(new Board { BoardId = 2, Name = "My Board 2", Owner = sally });
